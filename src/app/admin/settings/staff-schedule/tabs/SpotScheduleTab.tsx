...
export default function SpotScheduleTab({ staff, initialOverrides, startDate, endDate }: Props) {
  ...
  async function refresh() {
    const r = await listOverrides({ startDate, endDate });
