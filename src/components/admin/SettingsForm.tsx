        ...
        <div className="space-y-8">
            ...
            <CardContent className="pt-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input 
                    type="number" 
                    value={settings?.target_income || 0} 
                    onChange={(e) => updateField("target_income", parseInt(e.target.value))}
                  />
                </div>
                <div className="space-y-2">
                  <Label>目標来院数 (人)</Label>
                  <Input 
                    type="number" 
                    value={settings?.target_patients || 0} 
                    onChange={(e) => updateField("target_patients", parseInt(e.target.value))}
                  />
                </div>
                <div className="space-y-2">
                  <Label>目標新患数 (人)</Label>
                  <Input 
                    type="number" 
                    value={settings?.target_new_patients || 0} 
                    onChange={(e) => updateField("target_new_patients", parseInt(e.target.value))}
                  />
                </div>
                <div className="space-y-2">
                  <Label>目標リピート率 (%)</Label>
                  <Input 
                    type="number" 
                    value={settings?.target_repeat_rate || 0} 
                    onChange={(e) => updateField("target_repeat_rate", parseInt(e.target.value))}
                  />
                </div>
                <div className="space-y-2 col-span-2">
                  ...
                  <Input 
                    type="number" 
                    value={settings?.target_sns_tasks || 0} 
                    onChange={(e) => updateField("target_sns_tasks", parseInt(e.target.value))}
                  />
                </div>
              </div>
            </CardContent>
          ...
          <Card className="shadow-sm border-slate-200">
            <CardHeader className="bg-green-50 border-b pb-4">
              ...
              <CardDescription>Messaging API の連携情報を設定します</CardDescription>
            </CardHeader>
            <CardContent className="pt-6 space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  value={settings?.line_official_account_url || ""} 
                  onChange={(e) => updateField("line_official_account_url", e.target.value)}
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => updateField("line_channel_secret", e.target.value)}
                />
              </div>
            </CardContent>
          </Card>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(val) => updateField("target_persona", val)}
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={settings?.video_tone || ""} 
                      onValueChange={(val) => updateField("video_tone", val)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="選択してください" />
                      </SelectTrigger>
